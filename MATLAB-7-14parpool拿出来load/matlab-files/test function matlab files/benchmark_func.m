function f=benchmark_func(x,func_num,o,M,bias)
global initial_flag
persistent fhd f_bias
global o M
initial_flag =0;
% addpath('F:\Matlab\bin\2018第二阶段PSO+NN\2018-7-10分隔初始化+并行\2018-7-5-parpool\matlab-files\test function matlab files');
